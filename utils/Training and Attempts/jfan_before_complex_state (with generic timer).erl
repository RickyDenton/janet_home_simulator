...
init(Cfg) ->
 ...
 {ok,Cfg#fancfg.onoff,Cfg,[{{timeout,genTimeout},5000,genTimeoutData}]}.  % Initial State + Data
 
%% ======================================================== HANDLE_EVENT ======================================================== %% 



handle_event({timeout,genTimeout},genTimeoutData, DevmState,Cfg) ->
 io:format("[dev_statem]: i'm in genTimeout (DevmState = ~w, Cfg = ~p)~n",[DevmState,Cfg]), 
 {keep_state_and_data,[{{timeout,genTimeout},5000,genTimeoutData}]};
